...
{
    using InitializerTypes;
    using Mapping;
    using NUnit.Framework;

    namespace InitializerTypes
    {
    ...
    [TestFixture]
    public class Initializing_an_interface_with_an_empty_object
    {
        [Test]
        public void Should_return_the_interface_object()
        {
            ...
            var (empty, _) = factory.Create(factoryContext);

            Assert.That(empty, Is.Not.Null);
            Assert.That(empty, Is.InstanceOf<SoEmpty>());
        }
