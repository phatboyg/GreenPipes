...
namespace GreenPipes.Agents
{
    ...
    public static class SupervisorExtensions
    {
        ...
        public static PipeContextHandle<T> AddContext<T>(this ISupervisor supervisor, T context)
        ...
        /// <typeparam name="T">The context type</typeparam>
        /// <returns>A context handle</returns>
        public static PipeContextHandle<T> AddContext<T>(this ISupervisor supervisor, Task<T> context)
            where T : class, PipeContext
        {
            if (supervisor == null)
                throw new ArgumentNullException(nameof(supervisor));
        ...
        /// <typeparam name="T">The context type</typeparam>
        /// <returns>A context handle</returns>
        public static ActivePipeContextHandle<T> AddActiveContext<T>(this ISupervisor supervisor, PipeContextHandle<T> contextHandle, Task<T> context)
            where T : class, PipeContext
        {
            if (supervisor == null)
                throw new ArgumentNullException(nameof(supervisor));
