...
namespace GreenPipes.Policies
{
        ...
        RetryContext
    {
        ...
        public IntervalRetryContext(IntervalRetryPolicy policy, Exception exception, int retryCount)
        {
            _policy = policy;
        ...
        {
            retryContext = new IntervalRetryContext(_policy, Exception, _retryCount + 1);
