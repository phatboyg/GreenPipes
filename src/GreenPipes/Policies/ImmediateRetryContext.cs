...
namespace GreenPipes.Policies
{
    ...
    public class ImmediateRetryContext :
        RetryContext
    {
        readonly ImmediateRetryPolicy _policy;
        readonly int _retryCount;

        public ImmediateRetryContext(ImmediateRetryPolicy policy, Exception exception, int retryCount)
        {
            _policy = policy;
        ...
        {
            retryContext = new ImmediateRetryContext(_policy, Exception, _retryCount + 1);
